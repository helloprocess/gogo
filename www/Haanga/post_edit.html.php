...
/* Generated from /mnt/c/Users/rl/Documents/code/rodo/meneame/www/templates/post_edit.html */
function haanga_af98a3e38d5bdd049d7dc6d5bdd93518f9a2283d($vars167d5ff42b28ad, $return=FALSE, $blocks=array())
{
    ...
    $poll  = $self->poll;
    $vars167d5ff42b28ad['poll']  = $poll;
    echo ' '.Haanga::Load('poll_form.html', $vars167d5ff42b28ad, TRUE, $blocks).' <footer> <button type="button" class="btn btn-mnm btn-sm" data-show-poll="true"> <i class="fa fa-bar-chart"></i> </button> ';
