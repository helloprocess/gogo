...
/* Generated from /mnt/c/Users/rl/Documents/code/rodo/meneame/www/templates/header.html */
function haanga_606c3718a215bec2bd903ada0717954a3e2bd16b($vars167d616bf0ff6a, $return=FALSE, $blocks=array())
{
    global $globals, $current_user;
    extract($vars167d616bf0ff6a);
    if ($return == TRUE) {
        ob_start();
    }
    echo '<!DOCTYPE html> <html lang="'.$globals['lang'].'" prefix="og: http://ogp.me/ns#"> ';
    if (!isset($globals['partial']) || !$globals['partial']) {
        ...
        if (!$globals['mobile']) {
            ...
            if (!empty($globals['permalink']) && !empty($title)) {
        ...
        if ($globals['css_main']) {
            ...
            echo ' <link href="'.$globals['css_main'].'" rel="stylesheet" type="text/css" media="all" /> ';
        }
        ...
        if (!empty($globals['extra_head'])) {
            echo ' '.$globals['extra_head'].' ';
        }
        echo ' '.Haanga::Safe_Load('private/stats.html', $vars167d616bf0ff6a, TRUE, Array()).' '.Haanga::Safe_Load('private/header.html', $vars167d616bf0ff6a, TRUE, Array()).' </head> <body> <div class="header-top-wrapper pinned" style="';
        if ($this_site->color1) {
        ...
        echo ' '.Haanga::Load('header_userinfo.html', $vars167d616bf0ff6a, TRUE, $blocks).' </div> </div> ';
    } else {
    ...
    echo '  <script type="text/javascript"> '.Haanga::Load('../js/basic.js', $vars167d616bf0ff6a, TRUE, $blocks).' </script> <div id="header"> <div class="header-menu-wrapper"> <div id="header-menu" class="mnm-center-in-wrap"> <div class="header-menu01"';
    if ($globals['mobile']) {
