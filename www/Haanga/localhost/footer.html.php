...
/* Generated from /var/www/www/templates/footer.html */
function haanga_e74a5bfd5c2ebe60fb59263c336d21bdaa8fbb52($vars167d73807405c6, $return=FALSE, $blocks=array())
{
    ...
    echo ' </ul> </div> </div> </div>  <div id=\'backTop\'></div> '.Haanga::Load('footer_js.html', $vars167d73807405c6, TRUE, $blocks).' '.Haanga::Safe_Load('private/footer.html', $vars167d73807405c6, TRUE, Array()).' '.sprintf('<!--Delivered to you in %4.3f seconds-->', (microtime(TRUE) - $globals['start_time'])).' ';
    if (!$globals['partial']) {
        echo '  ';
