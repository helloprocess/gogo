...
/* Generated from /var/www/www/templates/sneak/base.html */
function haanga_f3115ab240ab7c96f3a569ed0454cf7136d8a4f3($vars167d810b5683fe, $return=FALSE, $blocks=array())
{
    global $globals, $current_user;
    extract($vars167d810b5683fe);
    if ($return == TRUE) {
        ob_start();
    }
    echo '
...
function to_html(data) {
    ...
    switch (data.type) {
        case \'post\':
            html += \'<img src="/img/common/sneak-newnotame01.png" width="21" height="17" alt="'._('nótame').'" class="tooltip p:\'+data.id+\'"/><\\/div>\';
            ...
            if (data.icon != undefined && data.icon.length > 0) {
                html += \'<a target="_blank" href="\'+base_url+\'user/\'+data.who+\'"><img src="/img/g.gif" data-2x="s:-20.:-40." data-src="\'+data.icon+\'" width=20 height=20 class="tooltip u:\'+data.uid+\' lazy"/><\\/a>\';
            }
            ...
            break;
        case \'chat\':
            html += \'<img src="/img/common/sneak-chat01.png" width="21" height="17" alt="'._('mensaje').'" title="'._('mensaje').'"/><\\/div>\';
            html += \'<div class="sneaker-votes">&nbsp;<\\/div>\';
            // Change the style
        ...
        case \'vote\':
            if (data.status == \''._('publicada').'\')
                html += \'<img src="/img/common/sneak-vote-published01.png" width="21" height="17" alt="'._('voto').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            else
                html += \'<img src="/img/common/sneak-vote01.png" width="21" height="17" alt="'._('voto').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'problem\':
            html += \'<img src="/img/common/sneak-problem01.png" width="21" height="17" alt="'._('problema').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'comment\':
            html += \'<img src="/img/common/sneak-comment01.png" width="21" height="17" alt="'._('comentario').'" class="tooltip c:\'+data.id+\'"/><\\/div>\';
            break;
        case \'new\':
            html += \'<img src="/img/common/sneak-new01.png" width="21" height="17" alt="'._('nueva').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'published\':
            html += \'<img src="/img/common/sneak-published01.png" width="21" height="17" alt="'._('publicada').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'discarded\':
            html += \'<img src="/img/common/sneak-reject01.png" width="21" height="17" alt="'._('descartada').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'edited\':
            html += \'<img src="/img/common/sneak-edit-notice01.png" width="21" height="17" alt="'._('editada').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'cedited\':
            html += \'<img src="/img/common/sneak-edit-comment01.png" width="21" height="17" alt="'._('comentario editado').'" class="tooltip c:\'+data.id+\'"/><\\/div>\';
            break;
        case \'geo_edited\':
            html += \'<img src="/img/common/sneak-geo01.png" width="21" height="17" alt="'._('geo editado').'" class="tooltip l:\'+data.id+\'"/><\\/div>\';
            break;
        case \'conversations\':
    ...
    if (data.type == \'problem\') {
        html += \'<div class="sneaker-who">\';
        html += \'<img src="/img/mnm/mnm-anonym-vote-01.png" width=20 height=20/>\';
