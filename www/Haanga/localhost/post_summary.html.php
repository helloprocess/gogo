...
/* Generated from /var/www/www/templates/post_summary.html */
function haanga_010b3cd1b08e23abe5c3bf4b0458442f5fcd9421($vars167d7406947fcf, $return=FALSE, $blocks=array())
{
    ...
    if ($self->can_vote) {
        ...
        if ($self->user_can_vote) {
            ...
            echo ' <span class="separator-vertical"></span> '.Haanga::Load('post_summary_votes.html', $vars167d7406947fcf, TRUE, $blocks).' ';
        }
        
    } else {
        echo ' '.Haanga::Load('post_summary_votes.html', $vars167d7406947fcf, TRUE, $blocks).' ';
    }
