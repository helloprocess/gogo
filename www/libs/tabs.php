...
final class Tabs
{
    public static function renderForSection($section, $options, $tab_class = null)
    {
        switch ($section) {
            case _('portada'):
            case _('post'):
                return self::renderForIndex($tab_class, $options);

            case _('nuevas'):
                return self::renderForShakeIt( $tab_class, $options);

            case _('populares'):
                return self::renderForTopStories($tab_class, $options);

            case _('más visitadas'):
                return self::renderForTopclicked($tab_class, $options);

            case _('nótame'):
                return self::renderForSneakme($tab_class, $options);
        }
    }
    ...
    public static function renderFromProfile(array $options, $tab_class = null)
    {
        switch ($options['view']) {
            case 'articles':
                return self::renderForProfileArticles($tab_class, $options);

            case 'articles_private':
                return self::renderForProfileArticlesPrivate($tab_class, $options);
    ...
    public static function renderForIndex($tab_class, $option)
    {
    ...
    public static function renderForShakeIt($tab_class, $option = -1)
    {
        global $globals, $current_user;
    ...
    public static function renderForTopstories($tab_class, $options)
    {
    ...
    public static function renderForTopclicked($tab_class, $options)
    {
    ...
    public static function renderForSneakme($tab_class, $options)
    {
        global $globals, $current_user;
    ...
    public static function renderUserProfileSubheader($tab_class, $options, $selected = false, $rss = false, $rss_title = '')
    {
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileProfile(), 0, 'rss?friends_of=' . $user->id, _('enví­os de amigos en rss2') );
    }
    ...
    public static function renderForProfileArticles($tab_class, $params)
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileArticles(), 0, false, '');
    }
    ...
    public static function renderForProfileArticlesPrivate($tab_class, $params)
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileArticlesPrivate(), 1, false, '');
    }
    ...
    public static function renderForProfileArticlesShaken($tab_class, $params)
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileArticlesShaken(), 2, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileArticlesFavorites(), 3, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileArticlesDiscard(), 4, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFriends(), 0, 'rss?friends_of=' . $user->id, _('enví­os de amigos en rss2'));
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFriendsOf(), 1, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileIgnored(), 2, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFriendsNew(), 3, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileHistory(), 0, 'rss?sent_by=' . $user->id, _('envíos en rss2'));
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileShaken(), 1, 'rss?voted_by=' . $user->id, _('votadas en rss2'));
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFavorites(), 2, 'rss?voted_by=' . $user->id, _('votadas en rss2'));
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFriendsShaken(), 3, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileDiscard(), 3, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileCommented(), 0, 'comments_rss?user_id=' . $user->id, _('comentarios en rss2'));
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileConversation(), 1, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileShakenComments(), 2, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileFavoriteComments(), 3, false, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileSubs(), 0, '');
    }
    ...
    {
        return self::renderUserProfileSubheader($tab_class, self::optionsForProfileNotes(), 0, '');
    }
