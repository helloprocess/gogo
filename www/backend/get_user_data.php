...
$db->real_query('
    SELECT `link_id`, `link_title`, `link_karma`, `link_votes`, `link_negatives`, `link_anonymous`,
...
$db->real_query('
    SELECT `comment_id`, `comment_date`, `comment_content`, `comment_order`, `comment_karma`, `comment_votes`,
...
$db->real_query('
    SELECT `post_id`, `post_date`, `post_content`, `post_karma`, `post_votes`,
